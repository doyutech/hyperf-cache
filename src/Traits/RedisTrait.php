...
trait RedisTrait
{
     ...
     * @return int
     */
    public static function getSortedListLenExt(string $poolName, string $key, int $startScore, int $endScore): int
    {
     ...
     * @return bool
     */
    public static function hasInUnSortedList(string $poolName, string $key, $value): array
    {
